# Engineering Writing Static Core

This static fragment records the default writing path:

1. Build one-sentence thesis.
2. Build contribution-evidence map.
3. Define figure/table responsibilities if visuals are involved.
