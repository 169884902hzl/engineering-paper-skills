...
| Latest local structured-contract attempt | `80d9c23b8b9e6fd42470df845547724d63a8cc48` |
...
| `tests/outputs/model_runs/full_paper_realistic_structured_audit_80d9c23_failed.json` | recorded local structured-contract attempt after span checks | `local_single_run_failed` |
| `evals/results/80d9c23_full_paper_model_eval.jsonl` | failure eval record for the latest local structured contract attempt | `local_single_run_failed` |
...
- No public CI-controlled model-run artifact is available for `6bec865` or
  `80d9c23`.
